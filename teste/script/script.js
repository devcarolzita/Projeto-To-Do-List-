...
button.addEventListener("click", function (event) {
    ...
    // ----- dragstart é onde começa a nossa viagem pelo drag n' drop  ele define que o elemento pode ser arrastado 
    ...
    taskDiv.addEventListener("dragover", function (ev) { //
        ...
        this.parentNode.insertBefore(dragging, node); // aqui usamos o insertBefore para não ficar por último aqui ele funciona como um appendchild. chamamos o parent node do "this" ou seja do taskdiv que é o taskbox pq é lá que vamos colocar mexer nas div né > definimos que queremos que ele o dragging ou seja a div que selecionamos fique antes do node a div que queremos substituir
    })
